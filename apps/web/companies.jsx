                        ...
                        {types.map((t) => (
                            <button
                                ...
                                className={`rounded-md px-3 py-1.5 font-mono text-[11px] font-bold uppercase tracking-wider transition-all ${
                                    filterType === t ? "bg-[#f0a500]/15 border border-[#f0a500]/40 text-[#f0a500]" : "border border-white/[0.08] bg-white/[0.03] text-[#6b7280] hover:text-[#eef0f4]"
                                }`}
                            >
                                {t}
                            </button>
                            ...
                            {selectedCompany.regulatoryActivity && selectedCompany.regulatoryActivity.length > 0 && (
                                <div className="mt-8">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        {selectedCompany.regulatoryActivity.map((docket, idx) => (
